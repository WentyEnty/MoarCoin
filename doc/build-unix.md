...
If you want to build MoarCoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a MoarCoin-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the MoarCoin directory
BDB_PREFIX="${MOARCOIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure MoarCoin Core to use our own-built instance of BDB
cd $MOARCOIN_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip MoarCoind" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build MoarCoind with compile script
---------------------
...
Security
---------------------
To help make your MoarCoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, MoarCoin should be built with a non-executable stack
