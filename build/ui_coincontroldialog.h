...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MOAR"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MOAR"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MOAR"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MOAR"));
