...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MoarCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MoarCoin</b> version", 0));
...
"Copyright \302\251 2017-2018 The MoarCoin developers", 0));
