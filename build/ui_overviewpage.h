...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelAnonymized->setText(QStringLiteral("0 MOAR"));
        ...
        MoarCoinlogo = new QLabel(frame_2);
        MoarCoinlogo->setObjectName(QStringLiteral("MoarCoinlogo"));
        MoarCoinlogo->setPixmap(QPixmap(QString::fromUtf8(":/images/MoarCoinlogo")));
        MoarCoinlogo->setScaledContents(false);
        MoarCoinlogo->setAlignment(Qt::AlignCenter);
        MoarCoinlogo->setMargin(60);

        verticalLayout->addWidget(MoarCoinlogo);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the MoarCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelDarksendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the MoarCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 MOAR / 0 Rounds", 0));
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the MoarCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        MoarCoinlogo->setText(QString());
    } // retranslateUi
